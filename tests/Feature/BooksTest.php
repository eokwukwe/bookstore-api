...
class BooksTest extends TestCase
{
     ...
     */
    public function
    it_validates_that_the_type_member_is_given_when_creating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
     ...
     */
    public function
    it_validates_that_the_type_member_has_the_value_of_books_when_creating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
     ...
     */
    public function
    it_validates_that_the_attributes_member_has_been_given_when_creating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
     ...
     */
    public function
    it_validates_that_the_attributes_member_is_an_object_when_creating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
        $this->postJson('/api/v1/books', [
     ...
     */
    public function
    it_validates_that_a_title_attribute_is_given_when_creating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
     ...
     */
    public function
    it_validates_that_a_description_attribute_is_given_when_creating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
     ...
     */
    public function
    it_validates_that_a_description_attribute_is_a_string_when_creating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
     ...
     */
    public function
    it_validates_that_a_publication_year_attribute_is_given_when_creating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
     ...
     */
    public function
    it_validates_that_a_publication_year_attribute_is_a_string_when_creating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
    ...
    public function it_can_update_a_book_from_a_resource_object()
    {
        ...
        $this->patchJson('/api/v1/books/1', [
            'data' => [
                ...
                'type' => 'books',
                'attributes' => [
                    'title' => 'Building an API with Laravel Updated',
                ]
            ]
        ], [
            'accept' => 'application/vnd.api+json',
     ...
     */
    public function
    it_validates_that_an_id_member_is_given_when_updating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
        $book = factory(Book::class)->create();
     ...
     */
    public function
    it_validates_that_an_id_member_is_a_string_when_updating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
        $book = factory(Book::class)->create();
     ...
     */
    public function
    it_validates_that_the_type_member_is_given_when_updating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
        $book = factory(Book::class)->create();
     ...
     */
    public function
    it_validates_that_the_type_member_has_the_value_of_books_when_updating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
        $book = factory(Book::class)->create();
     ...
     */
    public function
    it_validates_that_the_attributes_member_has_been_given_when_updating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
        $book = factory(Book::class)->create();
     ...
     */
    public function
    it_validates_that_the_attributes_member_is_an_object_given_when_updating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
        $book = factory(Book::class)->create();
        ...
        $this->patchJson('/api/v1/books/1', [
            'data' => [
                'id' => '1',
                'type' => 'books',
                'attributes' => 'this is the attributes field'
            ]
        ], [
            'accept' => 'application/vnd.api+json',
            'content-type' => 'application/vnd.api+json',
     ...
     */
    public function
    it_validates_that_a_title_attribute_is_a_string_when_updating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
        $book = factory(Book::class)->create();
     ...
     */
    public function
    it_validates_that_a_description_attribute_is_a_string_when_updating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
        $book = factory(Book::class)->create();
     ...
     */
    public function
    it_validates_that_a_publication_year_attribute_is_a_string_when_updating_a_book()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
        $book = factory(Book::class)->create();
